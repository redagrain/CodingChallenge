...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $products = [
            ...
            ['name' => 'Men\'s T-shirt', 'price' => 12.99, 'description' => '100% cotton T-shirt, available in multiple colors', 'category_id' => 2],
            ['name' => 'Men\'s Jeans', 'price' => 39.99, 'description' => 'Slim-fit denim jeans with stretch fabric', 'category_id' => 2],
        ];
